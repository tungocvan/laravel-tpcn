                    ...
                    <div class="nav-item-wrapper">
                        ...
                        <div class="parent-wrapper label-1">
                            <ul class="nav parent collapse show" data-bs-parent="#navbarVerticalCollapse" id="home"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{$active === 'user'?'active' : ''}} " href="/home-phoenix/user" data-bs-toggle=""
                                        aria-expanded="false">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{$active === 'create'?'active' : ''}}" href="/home-phoenix/user/create" data-bs-toggle=""
                                        aria-expanded="false">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1 collapsed"
                            ...
                            <div class="d-flex align-items-center">
                                <div class="dropdown-indicator-icon"><svg class="svg-inline--fa fa-caret-right"
                                    ...
                                    </svg></span><span class="nav-link-text">Icons</span>
                            </div>
                        </a>
                        <div class="parent-wrapper label-1">
